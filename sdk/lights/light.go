...
func GetLight(client *sdk_client.SdkClient, id string) (*Light, *common.ErrorHUE, error) {
	light := &Light{}
...
func GetLightIdByName(client *sdk_client.SdkClient, name string) (string, *common.ErrorHUE, error) {
	var lightId string
